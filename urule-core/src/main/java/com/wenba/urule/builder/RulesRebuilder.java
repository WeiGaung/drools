 ...
 * the License.
 ******************************************************************************/
package com.wenba.urule.builder;
...
import com.wenba.urule.model.library.action.Parameter;
import com.wenba.urule.model.library.constant.Constant;
import org.apache.commons.lang.StringUtils;

import com.wenba.urule.RuleException;
import com.wenba.urule.action.Action;
import com.wenba.urule.action.ConsolePrintAction;
import com.wenba.urule.action.ExecuteMethodAction;
import com.wenba.urule.action.VariableAssignAction;
import com.wenba.urule.model.flow.Connection;
import com.wenba.urule.model.flow.DecisionItem;
import com.wenba.urule.model.library.Datatype;
import com.wenba.urule.model.library.ResourceLibrary;
import com.wenba.urule.model.library.action.ActionLibrary;
import com.wenba.urule.model.library.action.Method;
import com.wenba.urule.model.library.action.SpringBean;
import com.wenba.urule.model.library.constant.ConstantCategory;
import com.wenba.urule.model.library.variable.Variable;
import com.wenba.urule.model.library.variable.VariableCategory;
import com.wenba.urule.model.rule.CommonFunctionValue;
import com.wenba.urule.model.rule.ComplexArithmetic;
import com.wenba.urule.model.rule.ConstantValue;
import com.wenba.urule.model.rule.Library;
import com.wenba.urule.model.rule.MethodValue;
import com.wenba.urule.model.rule.NamedReferenceValue;
import com.wenba.urule.model.rule.Other;
import com.wenba.urule.model.rule.ParameterValue;
import com.wenba.urule.model.rule.ParenValue;
import com.wenba.urule.model.rule.Rhs;
import com.wenba.urule.model.rule.Rule;
import com.wenba.urule.model.rule.Value;
import com.wenba.urule.model.rule.VariableCategoryValue;
import com.wenba.urule.model.rule.VariableValue;
import com.wenba.urule.model.rule.lhs.AbstractLeftPart;
import com.wenba.urule.model.rule.lhs.CommonFunctionLeftPart;
import com.wenba.urule.model.rule.lhs.CommonFunctionParameter;
import com.wenba.urule.model.rule.lhs.Criteria;
import com.wenba.urule.model.rule.lhs.CriteriaUnit;
import com.wenba.urule.model.rule.lhs.Criterion;
import com.wenba.urule.model.rule.lhs.FunctionLeftPart;
import com.wenba.urule.model.rule.lhs.Junction;
import com.wenba.urule.model.rule.lhs.JunctionType;
import com.wenba.urule.model.rule.lhs.Left;
import com.wenba.urule.model.rule.lhs.LeftPart;
import com.wenba.urule.model.rule.lhs.LeftType;
import com.wenba.urule.model.rule.lhs.MethodLeftPart;
import com.wenba.urule.model.rule.lhs.NamedCriteria;
import com.wenba.urule.model.rule.lhs.NamedItem;
import com.wenba.urule.model.rule.lhs.NamedJunction;
import com.wenba.urule.model.rule.lhs.VariableLeftPart;
import com.wenba.urule.model.rule.loop.LoopEnd;
import com.wenba.urule.model.rule.loop.LoopRule;
import com.wenba.urule.model.rule.loop.LoopStart;
import com.wenba.urule.model.rule.loop.LoopTarget;
...
public class RulesRebuilder {
	...
	public void rebuildAction(Action action,ResourceLibrary resLibraries,Map<String,String> namedMap,boolean forDSL){
		...
		if(action instanceof VariableAssignAction){
			...
			List<com.wenba.urule.model.rule.Parameter> parameters=methodAction.getParameters();
	...
	private void rebuildParameters(ResourceLibrary resLibraries, List<com.wenba.urule.model.rule.Parameter> parameters, List<Parameter> targetParameters, Map<String,String> namedMap, boolean forDSL) {
		if(parameters!=null && targetParameters!=null){
			for(int i=0;i<parameters.size();i++){
				if(i>targetParameters.size()-1){
					break;
				}
				com.wenba.urule.model.rule.Parameter parameter=parameters.get(i);
	...
	private void rebuildCriteria(ResourceLibrary resLibraries,Criteria criteria,Map<String,String> namedMap,boolean forDSL) {
		...
		if(leftPart instanceof VariableLeftPart){
			...
			List<com.wenba.urule.model.rule.Parameter> parameters=part.getParameters();
			rebuildParameters(resLibraries, parameters,targetMethod.getParameters(),namedMap,forDSL);
		}else if(leftPart instanceof FunctionLeftPart){
			FunctionLeftPart part=(FunctionLeftPart)leftPart;
			List<com.wenba.urule.model.rule.Parameter> parameters=part.getParameters();
			if(parameters!=null && parameters.size()>0){
				for(com.wenba.urule.model.rule.Parameter param:parameters){
	 ...
	 public void rebuildValue(Value value,ResourceLibrary resLibraries,Map<String,String> namedMap,boolean forDSL){
		...
		if(value instanceof ParenValue){
			...
			List<com.wenba.urule.model.rule.Parameter> parameters=methodValue.getParameters();
			rebuildParameters(resLibraries, parameters,targetMethod.getParameters(),namedMap,forDSL);
		}
