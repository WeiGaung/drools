...
import com.wenba.urule.model.library.action.annotation.ActionBean;
import com.wenba.urule.model.library.action.annotation.ActionMethod;
import com.wenba.urule.model.library.action.annotation.ActionMethodParameter;
...
public class BuiltInActionLibraryBuilder implements ApplicationContextAware{
	...
	private List<com.wenba.urule.model.library.action.Method> buildMethod(Method[] methods){
		List<com.wenba.urule.model.library.action.Method> list=new ArrayList<com.wenba.urule.model.library.action.Method>();
		for(Method m:methods){
			ActionMethod methodAnnotation=m.getAnnotation(ActionMethod.class);
			if(methodAnnotation==null)continue;
			String name=methodAnnotation.name();
			String methodName=m.getName();
			com.wenba.urule.model.library.action.Method libMethod=new com.wenba.urule.model.library.action.Method();
