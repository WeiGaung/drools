package com.wenba.rest.controller.utils;
...
public class GenDroolsEntityUtil {
    ...
    private static final String URL ="jdbc:mysql://10.2.1.154:3306/drools";
    private static final String NAME = "root";
    private static final String PASS = "wenba12@#";
    private static final String DRIVER ="com.mysql.jdbc.Driver";

    /*
     * 构造函数
     */
    public GenDroolsEntityUtil(){
        //创建连接
        Connection con;
        //查要生成实体类的表
...
//				String outputPath = directory.getAbsolutePath()+ "/src/"+path.substring(path.lastIndexOf("/com/", path.length()), path.length()) + initcap(tablename) + ".java";
                ...
                String fileName = directory.getAbsolutePath() + File.separator + initcap(tablename) + ".java";
